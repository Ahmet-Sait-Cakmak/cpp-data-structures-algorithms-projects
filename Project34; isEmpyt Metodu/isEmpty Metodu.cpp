...
int main() {
	...
	cout << "Is the queue empty? " << endl << endl;
	...
	if (queue1->isEmpty()) {
		...
		cout << "No, the queue is not empty." << endl << endl;
	}
	...
	cout << "After enqueuing 12, 24, 7, and 15 to the queue: " << endl << endl;
