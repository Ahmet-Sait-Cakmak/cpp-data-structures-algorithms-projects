...
int main() {
	...
	cout << "DFS PostOrder Search Algoritmasi ile yazilmis binary search tree: ";

	binarySearchTree1->print_all_nodes_with_DFS_PostOrder_Search(binarySearchTree1->root);
