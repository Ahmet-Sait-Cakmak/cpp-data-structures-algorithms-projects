...
int main() {
	...
	cout << "Binary Search Tree'ye eklenen son node'un degeri: " << binarySearchTree1->root->adress_of_rightChild->adress_of_leftChild->adress_of_rightChild->deger << endl << endl;
