...
public:
	...
	void deleteNode(int _index) {
		...
		if (_index < 0 || _index >= number_of_nodes) {
			...
			adressHolder2->adress_of_nextNode = adressHolder1->adress_of_nextNode;
...
int main() {
	...
	adress_of_linkedList1->deleteNode(-2);

	adress_of_linkedList1->deleteNode(0);

	adress_of_linkedList1->printList();

	adress_of_linkedList1->deleteNode(1);
	...
	adress_of_linkedList1->deleteNode(23);
